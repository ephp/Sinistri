...
(function (window, document, $) {
	...
	$.extend(F, {
		...
		defaults: {
			...
			// HTML templates
			tpl: {
				wrap: '<div class="fancybox-wrap"><div class="fancybox-outer"><div class="fancybox-inner gradient-lightmedium"></div></div></div>',
		...
		showLoading: function () {
			...
			$('<div id="fancybox-loading"><div></div></div>').click(F.cancel).appendTo('body');
                        spinnerBigFancy.spin();
                        $('#fancybox-loading').append(spinnerBigFancy.el);
		},
