...
/**
 * Ephp\Bundle\WsInvokerBundle\Entity\Help\Field
 *
 * @ORM\Table(name="ws_help_output_fields")
 * @ORM\Entity(repositoryClass="Ephp\Bundle\WsInvokerBundle\Entity\Help\OutFieldRepository")
 */
class OutField
{
    /**
