...
<div class="btn success fileinput-button left" id="<?php echo $id ?>_bt_adde">
    <div class="progressbar fileupload-progressbar no-display-important" style="margin: 3px 10px; float: left;"><div id="progressbar-doc" style="width:0%;"></div></div>
    <button id="add_doc_button" class="<?php echo $css['load'] ?>" style="<?php echo $css['loadstyle'] ?>" type="button">Aggiungi</button>
    <input type="file" name="files[]" multiple>
</div>
<button id="cancel_doc_button" onclick="resetProgressbar()" class="<?php echo $css['x'] ?>" style="<?php echo $css['xstyle'] ?>" type="button"><span class="padding-left-15 remove_blue"></span></button>
    ...
    <div id="allegati_drag_drop" class="no-display">
        <div class="row fileuploadrow <?php echo $id ?>_row rounded-5 dropzoneDoc" id="<?php echo $id ?>row">
            <div class="fileupload-buttonbar">
                <input type="hidden" id="d" name="d" value="<?php echo $dir ?>">
                <input type="hidden" id="x" name="x" value="<?php echo $x ?>">
                <input type="hidden" id="y" name="y" value="<?php echo $y ?>">
                <input type="hidden" id="f" name="f" value="<?php echo $id ?>">
        ...
        <java_script id="template-upload" type="text/html">
        ...
        <java_script id="template-download" type="text/html">
            {% for (var i=0, files=o.files, l=files.length, file=files[0]; i<l; file=files[++i]) { %}
