...
<div class="btn success fileinput-button left" id="<?php echo $id ?>_bt_adde" style="width: 62px;">
    ...
    <input type="file" name="files[]" style="width: 62px;" multiple>
</div>
<button id="cancel-doc-button" onclick="resetProgressbar()" class="<?php echo $css['x'] ?>" style="<?php echo $css['xstyle'] ?>"><span class="padding-left-15 remove_blue"></span></button>
