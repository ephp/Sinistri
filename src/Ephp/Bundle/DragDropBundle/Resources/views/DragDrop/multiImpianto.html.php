...
?>
<div id="cont_<?php echo $field ?>_tmb" class="dropzoneImpianto">
...
<div class="row fileuploadrow <?php echo $id ?>_row rounded-5 dropzoneImpianto" id="<?php echo $id ?>row">
...
//            $('#<?php echo $id ?>_bt_add').hide();
            ...
            chiudiBaloonDidascaliaImp(n_file++);
        }
    })
...
//        $('#<?php echo $id ?>_bt_add').hide();
    ...
    function cancella_img_<?php echo $field ?>(field) {
        ...
        chiudiBaloonDidascaliaImp('X_'+foto_id);
    }
    function didascalia_<?php echo $field ?>(n_file) {
        ...
        apriBaloonDidascaliaImp($('#dida'+n_file));
    }
