...
?>
<div id="cont_<?php echo $field ?>_tmb" class="dropzoneStrumento<?php echo $field ?>">
    <div id="<?php echo $field ?>_tmb" class="left rounded-5 img_strumento shadow">
        <?php if ($value): ?>
...
<div class="row fileuploadrow <?php echo $id ?>_row rounded-5 img_strumento shadow dropzoneStrumento" id="<?php echo $id ?>row">
...
<div class="btn success fileinput-button" style="position: absolute; left: 5px; top: 130px; z-index: 30;" id="<?php echo $id ?>_bt_adde">
...
<script type="text/javascript">
    ...
    $('#<?php echo $id ?>').fileupload({
        ...
        url: '/upload.php',
        autoUpload: true,
        dropZone: $('.dropzoneStrumento<?php echo $field ?>'),
