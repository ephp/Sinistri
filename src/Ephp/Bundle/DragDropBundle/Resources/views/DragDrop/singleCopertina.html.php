...
?>
<div id="cont_<?php echo $field ?>_tmb" class="dropzoneAzienda ">
    <div id="<?php echo $field ?>_tmb" class="img_azienda left">
        <?php if ($value): ?>
        <div style="width:150px;height:150px;overflow:hidden;" id="barno">
            <img id="img_azienda" src="<?php echo $tmb ?>" alt="anteprima" class="thumb" />
        </div>
        <?php endif; ?>
...
?>
<div class="row fileuploadrow <?php echo $id ?>_row rounded-5 img_azienda shadow dropzoneAzienda" id="<?php echo $id ?>row">
...
<div class="btn success fileinput-button" style="position: absolute; top:150px; left: 5px; z-index: 30;" id="<?php echo $id ?>_bt_adde">
    <button class="button-orange small">Carica una foto</button>
    <div class="clearer twenty"></div>
    <div class="progressbar fileupload-progressbar" style="width: 268px;"><div id="progressbar" style="width:0%;"></div></div>
