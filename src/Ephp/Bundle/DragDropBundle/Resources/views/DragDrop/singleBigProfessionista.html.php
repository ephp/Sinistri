...
<div id="cont_<?php echo $field ?>_tmb" class="dropzoneAzienda">
    <div id="<?php echo $field ?>_tmb" class="left rounded-5 img_azienda shadow">
        <?php if ($value): ?>
...
<div class="btn success fileinput-button" style="position: absolute; top: 292px; left: 10px; z-index: 30;" id="<?php echo $id ?>_bt_adde">
    <button class="button-orange small" style="width: 268px;">Carica una foto</button>
