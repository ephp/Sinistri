...
<div class="btn success fileinput-button left" id="<?php echo $id ?>_bt_adde" style="width: 62px;">
    <div class="progressbar fileupload-progressbar absolute" style="bottom: -23px; left: 5px; width: 100px;"><div id="progressbar-img" style="width:0%;"></div></div>
    <button id="add-img-button" class="<?php echo $css['load'] ?>" type="button">Aggiungi</button>
    <input type="file" name="filesImg[]" style="width: 62px;" id="filesImg" multiple>
</div>
<button id="cancel-img-button" onclick="resetProgressbar()" class="<?php echo $css['x'] ?>" style="width: 30px; left: -4px;" type="button"><span class="padding-left-15 remove_blue"></span></button>
                ...
                $.each(files, function (index, file) {
                    if(that._hasError(file)) {
                        switch(that._hasError(file)) {
                            case 'minFileSize':
                                fancyAlert('La foto ' +file.name+' è troppo piccolo (max: 1Kb)');
                                break;
                            case 'maxFileSize':
                                fancyAlert('La foto ' +file.name+' è troppo grande (max: 1Mb)');
                                break;
