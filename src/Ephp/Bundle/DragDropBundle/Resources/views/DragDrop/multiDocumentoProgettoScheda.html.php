...
<div class="btn success fileinput-button left relative" id="<?php echo $id ?>_bt_adde">
    <button class="button-orange smaller no-margin left" id="progetto-scheda" type="button">Carica allegati o la copertina</button>
...
<script type="text/javascript">  
    ...
    .bind('fileuploaddone', function (e, data) {
        ...
        $('#progetto-scheda').css({
            opacity: 1
        }).attr('disabled', false).html("Carica allegati o la copertina");
...
//        $('#<?php echo $id ?>_bt_add').show();
    ...
    .bind('fileuploadstart', function (e) {  
        $('#progetto-scheda').css({
            opacity: 0.5
        }).attr('disabled', true).html("Caricamento in corso");
...
//
//        li = $("<li id=\"allegatoProgetto_"+n_file+"\" class=\"no-display\"></li>").append(data.name).append(hidden).append(hidden2).append(hidden3).append(hidden4);
//        ul.prepend(li);
          resetAddButton();
          salvaProgetto(data,n_file);
    }
