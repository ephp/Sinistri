...
The ``B2SGeneratorBundle`` extends the default Symfony2 command line
...
`Download`_ the bundle and put it under the ``B2S\\Bundle\\`` namespace.
Then, like for any other bundle, include it in your Kernel class::
    ...
    public function registerBundles()
    {
        $bundles = array(
            ...
            new B2S\Bundle\GeneratorBundle\B2SGeneratorBundle(),
        );
...
The ``B2SGeneratorBundle`` come with four new commands that can be run in
...
.. _Download: http://github.com/sensio/B2SGeneratorBundle