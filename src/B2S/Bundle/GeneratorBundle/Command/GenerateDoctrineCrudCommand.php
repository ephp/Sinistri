...
namespace B2S\Bundle\GeneratorBundle\Command;
...
use B2S\Bundle\GeneratorBundle\Generator\DoctrineCrudGenerator;
use B2S\Bundle\GeneratorBundle\Generator\DoctrineFormGenerator;
use B2S\Bundle\GeneratorBundle\Command\Helper\DialogHelper;
use B2S\Bundle\GeneratorBundle\Manipulator\RoutingManipulator;
...
class GenerateDoctrineCrudCommand extends GenerateDoctrineCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->setHelp(<<<EOT
The <info>b2s:generate:crud</info> command generates a CRUD based on a Doctrine entity.

The default command only generates the list and show actions.

<info>php app/console b2s:generate:crud --entity=AcmeBlogBundle:Post --route-prefix=post_admin</info>
...
EOT
            ...
            ->setName('b2s:generate:crud')
            ->setAliases(array('b2s:doctrine:crud'))
        ;
    }
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        $entity = $dialog->askAndValidate($output, $dialog->getQuestion('The Entity shortcut name', $input->getOption('entity')), array('B2S\Bundle\GeneratorBundle\Command\Validators', 'validateEntityName'), false, $input->getOption('entity'));
        ...
        $format = $dialog->askAndValidate($output, $dialog->getQuestion('Configuration format (yml, xml, php, or annotation)', $format), array('B2S\Bundle\GeneratorBundle\Command\Validators', 'validateFormat'), false, $format);
    ...
    protected function getDialogHelper()
    {
        ...
        if (!$dialog || get_class($dialog) !== 'B2S\Bundle\GeneratorBundle\Command\Helper\DialogHelper') {
