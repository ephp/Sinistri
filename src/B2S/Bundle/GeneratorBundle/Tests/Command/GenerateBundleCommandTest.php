...
use B2S\Bundle\GeneratorBundle\Command\GenerateBundleCommand;
...
class GenerateBundleCommandTest extends GenerateCommandTest
{
    ...
    {
        $command = $this
            ->getMockBuilder('B2S\Bundle\GeneratorBundle\Command\GenerateBundleCommand')
    ...
    protected function getGenerator()
    {
        ...
        return $this
            ->getMockBuilder('B2S\Bundle\GeneratorBundle\Generator\BundleGenerator')
