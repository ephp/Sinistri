...
namespace B2S\Bundle\GeneratorBundle\Tests\Command;

use Symfony\Component\Console\Helper\HelperSet;
use Symfony\Component\Console\Helper\FormatterHelper;
use Symfony\Component\Console\Output\StreamOutput;
use Symfony\Component\Console\Tester\CommandTester;
use B2S\Bundle\GeneratorBundle\Command\GenerateDoctrineCrudCommand;
...
class GenerateDoctrineCrudCommandTest extends GenerateCommandTest
{
    ...
    {
        $command = $this
            ->getMockBuilder('B2S\Bundle\GeneratorBundle\Command\GenerateDoctrineCrudCommand')
    ...
    protected function getGenerator()
    {
        ...
        return $this
            ->getMockBuilder('B2S\Bundle\GeneratorBundle\Generator\DoctrineCrudGenerator')
            ->disableOriginalConstructor()
    ...
    {
        return $this
            ->getMockBuilder('B2S\Bundle\GeneratorBundle\Generator\DoctrineFormGenerator')
            ->disableOriginalConstructor()
            ->setMethods(array('generate'))
            ->getMock()
        ;
